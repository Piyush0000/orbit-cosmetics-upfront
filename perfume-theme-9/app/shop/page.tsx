         ...
         <div className="bg-background min-h-screen pt-32 pb-16">
            <div className="container mx-auto px-4">
                 ...
                 <div className="text-center mb-16 space-y-4">
                     ...
                     <h1 className="text-5xl md:text-7xl font-serif text-text-main italic tracking-tighter leading-none">All <span className="not-italic opacity-30 font-light">Fragrances</span></h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
                    ...
                    <div className="lg:col-span-3">
                        ...
                        <div className="mt-24 text-center">
                            <button className="glass-card border-white/10 text-white/30 py-6 px-12 text-[11px] uppercase font-bold tracking-[0.5em] hover:border-dream-violet hover:text-dream-violet transition-all duration-700 rounded-[35px_5px_35px_5px] shadow-2xl group/btn overflow-hidden relative">
                                ...
                                Extend <span className="not-italic opacity-30 font-light lowercase font-serif px-2 italic">expedition</span>
                            </button>
                        </div>
                    </div>
                </div>
