        ...
        <section className="py-40 relative bg-dream-peach/40 text-text-main overflow-hidden">
            ...
            <div className="container mx-auto px-6 max-w-7xl relative z-10 text-center">
                <div className="mb-16 flex justify-center">
                    <div className="w-24 h-24 rounded-[40px_10px_40px_10px] bg-white flex items-center justify-center text-dream-violet shadow-2xl border border-white/50 animate-float">
                ...
                <div className="flex flex-col sm:flex-row gap-8 justify-center">
                    <Link
                        href="/gifts/men"
                        className="px-14 py-6 bg-text-main text-black rounded-[40px_10px_40px_10px] text-xs uppercase tracking-[0.3em] font-bold hover:bg-dream-violet transition-all duration-700 shadow-[0_20px_40px_-5px_rgba(0,0,0,0.2)] min-w-[240px]"
                    >
                        For Him
                    </Link>
                    <Link
                        href="/gifts/women"
                        className="px-14 py-6 glass-card text-text-main rounded-[40px_10px_40px_10px] text-xs uppercase tracking-[0.3em] font-bold hover:bg-white hover:text-black transition-all duration-700 min-w-[240px] shadow-lg"
                    >
                        For Her
                    </Link>
                </div>
