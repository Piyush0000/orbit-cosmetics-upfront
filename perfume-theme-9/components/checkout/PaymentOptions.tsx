...
export default function PaymentOptions() {
    ...
    return (
        <div className="glass-card p-8 sm:p-12 rounded-[50px_10px_50px_10px] border-white/5 shadow-2xl backdrop-blur-2xl relative overflow-hidden group">
            ...
            <h2 className="font-serif text-3xl text-text-main mb-10 pb-6 border-b border-white/5 italic tracking-tight relative z-10 flex items-center gap-4">
                ...
                Payment <span className="not-italic opacity-30">Gateway</span>
            </h2>
            ...
            <div className="space-y-6 relative z-10">
                {PAYMENT_METHODS.map((method) => (
                    <div
                        ...
                        className={cn(
                            "relative overflow-hidden cursor-pointer transition-all duration-700 flex items-center justify-between p-6 rounded-[25px_5px_25px_5px] group/method",
                    ...
                    >
                        ...
                        <div className="flex items-center gap-6">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] text-white/30 mt-1 uppercase tracking-wider font-medium">{method.description}</p>
                            </div>
                        </div>

                        <div className={cn(
                            "w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all duration-700",
                            selectedMethod === method.id ? "border-white animate-pulse" : "border-white/10"
                        )}>
                            {selectedMethod === method.id && (
            ...
            <div className="mt-10 p-6 glass-card border-white/5 bg-white/[0.02] rounded-[20px_5px_20px_5px] relative z-10">
