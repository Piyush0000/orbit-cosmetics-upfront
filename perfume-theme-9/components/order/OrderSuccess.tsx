    ...
    return (
        <div className="text-center max-w-2xl mx-auto relative z-10">
            ...
            <h1 className="font-serif text-4xl lg:text-5xl text-text-main mb-6 italic tracking-tight">
                Essence <span className="not-italic opacity-30">Confirmed</span>
            </h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 text-left mb-16">
                {/* Order ID Card */}
                <div className="glass-card p-8 rounded-[30px_5px_30px_5px] border-white/5 relative overflow-hidden group/card shadow-2xl backdrop-blur-xl">
                    ...
                    <div className="flex items-center gap-5 relative z-10">
                        <div className="w-12 h-12 glass-panel border-white/10 flex items-center justify-center rounded-full bg-white/5">
                ...
                {/* Delivery Date Card */}
                <div className="glass-card p-8 rounded-[5px_30px_5px_30px] border-white/5 relative overflow-hidden group/card shadow-2xl backdrop-blur-xl">
            ...
            <p className="text-[9px] text-white/20 uppercase tracking-[0.3em] font-bold max-w-md mx-auto leading-relaxed border-t border-white/5 pt-10">
