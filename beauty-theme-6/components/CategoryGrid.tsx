            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div ref={scrollRef} className="flex gap-5 overflow-x-auto pb-4 scrollbar-hide snap-x snap-mandatory" style={{ scrollbarWidth: "none", msOverflowStyle: "none" }}>
                    {categories.map((cat) => (
                        <Card
                            key={cat.name}
                            className="group cursor-pointer hover:shadow-xl hover:shadow-primary/8 transition-all duration-500 border border-border/40 bg-card hover:-translate-y-1 rounded-2xl flex-shrink-0 w-[200px] snap-start"
                        >
