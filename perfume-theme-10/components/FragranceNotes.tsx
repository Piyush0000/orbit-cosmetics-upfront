            ...
            <div className="container mx-auto px-6 max-w-7xl relative z-10">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-x-10 gap-y-16">
                    {NOTES.map((note) => (
                        ...
                        >
                            <div className="w-24 h-24 rounded-full bg-white shadow-sm flex items-center justify-center mb-6 group-hover:shadow-2xl group-hover:bg-dream-mint transition-all duration-700 border border-dream-violet/10 relative overflow-hidden group-hover:-translate-y-4 group-hover:-rotate-3">
