            ...
            <div className="container mx-auto max-w-7xl relative z-10">
                <div className="flex flex-col items-center mb-32 text-center">
                    <div className="px-5 py-2 glass-card mb-8">
                        <span className="text-[10px] uppercase tracking-[0.4em] font-bold text-text-muted">Dream Worlds • Categories</span>
                    </div>
                    <h2 className="text-6xl md:text-8xl font-serif text-text-main leading-none tracking-tighter">Choose Your <br /> <span className="italic opacity-70">Discovery</span></h2>
                </div>
                        ...
                        <div key={idx} className="group relative animate-fade-in flex flex-col items-center w-full">
                            <Link href={category.href} className="block relative w-full aspect-square mb-10 group/item max-w-[180px] sm:max-w-[220px] lg:max-w-[280px] mx-auto">
                                ...
                                <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 flex items-center justify-center opacity-0 group-hover/item:opacity-100 transition-all duration-500 translate-y-4 group-hover/item:translate-y-0 text-center z-20">
                                    <div className="glass-card px-8 py-3 shadow-md bg-white/70 rounded-full">
                            ...
                            <div className="space-y-3 text-center">
                                ...
                                <div className="w-8 h-[1px] bg-text-muted/30 mx-auto" />
                                <p className="text-[10px] uppercase tracking-[0.3em] font-bold text-text-muted">{category.subtitle}</p>
                            </div>
                        </div>
                    ))}
                </div>
