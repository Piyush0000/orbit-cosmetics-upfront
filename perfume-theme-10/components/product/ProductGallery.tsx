...
export default function ProductGallery({ images }: ProductGalleryProps) {
    ...
    return (
        <div className="flex flex-col-reverse md:flex-row gap-6">
            ...
            <div className="flex md:flex-col gap-5 overflow-x-auto md:overflow-visible py-2 md:py-0 scrollbar-hide">
                {images.map((img, idx) => (
                    <button
                        ...
                        className={cn(
                            "relative w-24 h-24 flex-shrink-0 transition-all duration-700 rounded-[30px] overflow-hidden border",
                            selectedImage === idx 
            ...
            {/* Main Image Area */}
            <div className="relative flex-grow aspect-square glass-card border-white/5 overflow-hidden group rounded-[60px] shadow-2xl">
