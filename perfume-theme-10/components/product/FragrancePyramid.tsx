...
export default function FragrancePyramid({ topNotes, middleNotes, baseNotes }: FragrancePyramidProps) {
    return (
        <div className="py-24 glass-card border-black/5 rounded-[60px] relative overflow-hidden group">
                    ...
                    >
                        {topNotes.map((note, i) => (
                            <div key={i} className="flex flex-col items-center gap-4 group/note">
                                <div className="w-20 h-20 rounded-full glass-card flex items-center justify-center border-black/10 group-hover/note:border-dream-violet group-hover/note:bg-dream-violet transition-all duration-700 shadow-2xl group-hover/note:shadow-dream-violet/40">
                ...
                <div className="text-center relative w-full">
                    ...
                    >
                        {middleNotes.map((note, i) => (
                            <div key={i} className="flex flex-col items-center gap-4 group/note">
                                <div className="w-24 h-24 rounded-full glass-card flex items-center justify-center border-black/10 group-hover/note:border-dream-violet group-hover/note:bg-dream-violet transition-all duration-700 shadow-2xl group-hover/note:shadow-dream-violet/40">
                ...
                <div className="text-center relative w-full">
                    ...
                    >
                        {baseNotes.map((note, i) => (
                            <div key={i} className="flex flex-col items-center gap-4 group/note">
                                <div className="w-28 h-28 rounded-full glass-card flex items-center justify-center border-black/10 group-hover/note:border-dream-violet group-hover/note:bg-dream-violet transition-all duration-700 shadow-2xl group-hover/note:shadow-dream-violet/40">
