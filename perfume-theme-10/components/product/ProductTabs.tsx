...
export default function ProductTabs({ product }: ProductTabsProps) {
    ...
    return (
        <div className="mt-32">
            {/* Tabs Header */}
            <div className="flex justify-center border-b border-black/10 mb-16 overflow-x-auto pb-2 scrollbar-hide">
                ...
                <AnimatePresence mode="wait">
                    {activeTab === 'description' && (
                        ...
                        >
                            ...
                            <div className="grid md:grid-cols-2 gap-10 mt-12">
                                <div className="glass-card p-10 rounded-[40px] border-black/5">
                                    <h4 className="font-serif text-2xl text-text-main mb-6 italic tracking-tight">Occasion <span className="opacity-60 not-italic">Mood</span></h4>
                                ...
                                <div className="glass-card p-10 rounded-[40px] border-black/5">
                                    <h4 className="font-serif text-2xl text-text-main mb-6 italic tracking-tight">Seasonal <span className="opacity-60 not-italic">Harmony</span></h4>
                                    <div className="flex flex-wrap gap-3">
                    ...
                    {activeTab === 'ingredients' && (
                        ...
                        >
                            ...
                            <p className="text-[10px] uppercase tracking-[0.3em] text-text-muted max-w-lg mx-auto leading-relaxed">
                            ...
                            <div className="flex flex-col gap-10">
                                {product.reviewData && product.reviewData.length > 0 ? (
                                    product.reviewData.map(review => (
                                        <div key={review.id} className="glass-card p-10 rounded-[40px] border-black/5 relative overflow-hidden group">
                                            ...
                                            <div className="flex items-center justify-between mb-6">
                                                <div className="flex items-center gap-4">
                                                    <div className="w-12 h-12 rounded-full glass-card flex items-center justify-center text-dream-violet font-serif text-xl border-black/10">
                                                        {review.author[0]}
                                                    </div>
                                                ...
                                                <span className="text-[9px] uppercase tracking-[0.2em] text-text-muted font-bold">{review.date}</span>
                                            </div>
