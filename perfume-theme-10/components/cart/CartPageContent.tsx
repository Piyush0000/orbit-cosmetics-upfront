    ...
    return (
        <div className="bg-background min-h-screen pt-32 pb-24 relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10">
                {cartItems.length === 0 ? (
                    <div className="min-h-[50vh] flex flex-col items-center justify-center text-center px-4 glass-card p-16 rounded-[40px] border-white/5">
                        ...
                        <h2 className="text-4xl md:text-5xl font-serif text-text-main mb-6 tracking-tighter italic">Your Cart Is <span className="not-italic opacity-60">Waiting</span></h2>
                        ...
                        <Link
                            href="/shop"
                            className="bg-white text-black py-5 px-12 text-[10px] uppercase font-bold tracking-[0.4em] hover:bg-dream-violet transition-all duration-700 rounded-full shadow-2xl"
                        >
                            Explore Scents
                        </Link>
                    </div>
                    ...
                    <>
                        <div className="mb-20 text-center">
                            ...
                            <h1 className="text-6xl md:text-7xl font-serif text-text-main tracking-tighter leading-none italic">
                                Shopping <span className="not-italic opacity-60 font-light">Cart</span>
                            </h1>
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 lg:gap-24">
                            ...
                            <div className="lg:col-span-2 space-y-6">
                                <div className="flex justify-between items-center pb-6 border-b border-white/5 px-4">
                                    <span className="text-[10px] uppercase tracking-[0.3em] font-bold text-text-main">Signature Product</span>
                                    <span className="text-[10px] uppercase tracking-[0.3em] font-bold text-text-main hidden sm:block">Subtotal Essence</span>
                                </div>
