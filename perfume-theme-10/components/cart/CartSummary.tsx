...
export default function CartSummary({ subtotal, shipping, discount, onCheckout }: CartSummaryProps) {
    ...
    return (
        <div className="glass-card p-10 sm:p-12 rounded-[60px] h-fit sticky top-32 border-white/5 relative overflow-hidden group shadow-2xl backdrop-blur-2xl">
            ...
            <h2 className="font-serif text-3xl text-text-main mb-10 pb-6 border-b border-white/5 italic tracking-tight relative z-10 leading-none">Order <span className="not-italic opacity-60">Summary</span></h2>
            ...
            <p className="text-[9px] uppercase tracking-[0.2em] text-text-muted mt-10 mb-10 leading-relaxed font-bold relative z-10 text-center">
            ...
            <div className="space-y-4 relative z-10">
                ...
                <Link
                    href="/shop"
                    className="w-full glass-card border-white/10 text-text-muted py-5 px-8 text-[9px] uppercase font-bold tracking-[0.4em] hover:border-dream-violet hover:text-dream-violet transition-all duration-700 flex items-center justify-center gap-3 rounded-full bg-white/[0.02]"
                >
