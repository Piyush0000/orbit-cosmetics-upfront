    ...
    return (
        <aside className={`w-full ${className} relative z-10`}>
            <div className="flex items-center justify-between mb-8 pb-6 border-b border-white/5">
                <h3 className="font-serif text-2xl text-text-main italic tracking-tight">Aura <span className="not-italic opacity-60">Filters</span></h3>
                <button className="text-[9px] text-text-main hover:text-dream-violet uppercase tracking-[0.3em] font-bold transition-colors">Neutralize All</button>
            </div>
            ...
            <div className="space-y-10">
                ...
                <div className="border-b border-white/5 pb-8">
                    ...
                    >
                        ...
                        {openSections.genders ? <ChevronUp className="w-4 h-4 text-text-main" /> : <ChevronDown className="w-4 h-4 text-text-main" />}
                    </button>
                    <AnimatePresence>
                                    ...
                                    {filters.genders.map(gender => (
                                        <label key={gender} className="flex items-center gap-4 cursor-pointer group/item">
                                            <div className="relative flex items-center">
                                                <input type="checkbox" className="peer w-4 h-4 border-black/10 rounded-full bg-black/5 checked:bg-dream-violet checked:border-dream-violet focus:ring-0 transition-all duration-500 appearance-none cursor-pointer" />
                                            ...
                                            <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-text-main group-hover/item:text-dream-violet transition-colors">{gender}</span>
                                        </label>
                                    ))}
                                </div>
                            </motion.div>
                ...
                <div className="border-b border-white/5 pb-8">
                    ...
                    >
                        ...
                        {openSections.priceRanges ? <ChevronUp className="w-4 h-4 text-text-main" /> : <ChevronDown className="w-4 h-4 text-text-main" />}
                    </button>
                    <AnimatePresence>
                                ...
                                <div className="space-y-4">
                                    {filters.priceRanges.map((range, idx) => (
                                        <label key={idx} className="flex items-center gap-4 cursor-pointer group/item">
                                            ...
                                            <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-text-main group-hover/item:text-dream-violet transition-colors">{range.label}</span>
                                        </label>
                                    ))}
                                </div>
                            </motion.div>
                ...
                <div className="border-b border-white/5 pb-8">
                    ...
                    >
                        ...
                        {openSections.brands ? <ChevronUp className="w-4 h-4 text-text-main" /> : <ChevronDown className="w-4 h-4 text-text-main" />}
                    </button>
                    <AnimatePresence>
                        {openSections.brands && (
                            <motion.div
                                ...
                                <div className="space-y-4">
                                    {filters.brands.map(brand => (
                                        <label key={brand} className="flex items-center gap-4 cursor-pointer group/item">
                                            ...
                                            <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-text-main group-hover/item:text-dream-violet transition-colors">{brand}</span>
                                        </label>
                                    ))}
                                </div>
                            </motion.div>
                ...
                <div className="pb-8">
                    ...
                    >
                        ...
                        {openSections.concentrations ? <ChevronUp className="w-4 h-4 text-text-main" /> : <ChevronDown className="w-4 h-4 text-text-main" />}
                    </button>
                    <AnimatePresence>
                                ...
                                <div className="space-y-4">
                                    {filters.concentrations.map(conc => (
                                        <label key={conc} className="flex items-center gap-4 cursor-pointer group/item">
                                            ...
                                            <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-text-main group-hover/item:text-dream-violet transition-colors">{conc}</span>
                                        </label>
                                    ))}
                                </div>
                            </motion.div>
