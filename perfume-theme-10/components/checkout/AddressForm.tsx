...
export default function AddressForm() {
    return (
        <div className="glass-card p-8 sm:p-12 rounded-[60px] border-white/5 relative overflow-hidden group shadow-2xl backdrop-blur-2xl">
            ...
            <h2 className="font-serif text-3xl text-text-main mb-10 pb-6 border-b border-white/5 italic tracking-tight relative z-10 flex items-center gap-4">
                ...
                Shipping <span className="not-italic opacity-60">Sanctuary</span>
            </h2>
            ...
            <form className="grid grid-cols-1 md:grid-cols-2 gap-10 relative z-10">
                ...
                <div className="md:col-span-2 group/field">
                    ...
                    <input
                        ...
                        className="w-full border-b border-white/20 py-3 text-lg text-text-main placeholder:text-text-muted focus:outline-none focus:border-dream-violet transition-all duration-500 bg-transparent font-serif italic"
                    />
                </div>
                ...
                <div className="group/field">
                    <label htmlFor="altPhone" className="block text-[10px] font-bold uppercase tracking-[0.4em] text-dream-violet mb-4 transition-colors group-focus-within/field:text-text-main">
                        Alternate Phone <span className="opacity-60 font-normal italic lowercase tracking-normal">(Optional)</span>
                    </label>
                    <input
                        type="tel"
                        id="altPhone"
                ...
                <div className="md:col-span-2 group/field">
                    ...
                    <div className="relative">
                        ...
                        <div className="absolute right-0 top-1/2 -translate-y-1/2 pointer-events-none text-dream-violet opacity-60">
                ...
                <div className="md:col-span-2 group/field">
                    <label htmlFor="address" className="block text-[10px] font-bold uppercase tracking-[0.4em] text-dream-violet mb-4 transition-colors group-focus-within/field:text-text-main">
                        Address <span className="opacity-60 font-normal italic lowercase tracking-normal text-[8px]">(House No, Building, Street, Area)</span>
                    </label>
                    <textarea
                        id="address"
                        rows={3}
