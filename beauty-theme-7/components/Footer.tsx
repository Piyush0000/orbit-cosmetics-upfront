            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="col-span-1 md:col-span-1 space-y-6">
                        ...
                        <p className="text-muted-foreground text-sm uppercase tracking-widest leading-relaxed max-w-xs font-light">
                            Crafting editorial beauty for the modern enthusiast.
                        </p>
                        <div className="flex gap-0">
                            <Input placeholder="Newsletter" className="bg-transparent border-primary/20 shadow-none rounded-none text-xs uppercase tracking-widest h-12" />
                            <Button className="rounded-none px-8 bg-primary text-primary-foreground h-12 hover:bg-primary/90 font-bold uppercase text-[10px] tracking-[0.2em]">Join</Button>
                        </div>
                    </div>
