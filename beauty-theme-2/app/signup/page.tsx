        ...
        <div className="min-h-screen bg-background flex items-center justify-center px-4 py-20 animate-in fade-in duration-500 text-foreground">
            <div className="w-full max-w-md space-y-8">
                <div className="text-center">
                    <h1 className="text-4xl font-serif font-bold tracking-tight text-primary">Create Account</h1>
                    <p className="mt-2 text-sm text-muted-foreground">
                        Join us for an exclusive beauty experience
                    </p>
                </div>

                <div className="bg-card p-8 rounded-xl border border-border/40 shadow-xl relative overflow-hidden group">
                    ...
                    <form onSubmit={handleSignup} className="space-y-6 relative z-10">
                        <div className="space-y-2">
                            ...
                            <Input id="name" placeholder="Jane Doe" required className="h-12 bg-background/50 border-input focus:border-primary text-foreground placeholder:text-muted-foreground" />
                        </div>
                        <div className="space-y-2">
                        ...
                        <Button className="w-full py-6 text-lg tracking-wide shadow-md hover:shadow-primary/20 transition-all font-medium text-primary-foreground bg-primary hover:bg-primary/90" disabled={loading}>
