...
export default function ShopPage() {
    ...
    return (
        <div className="bg-background min-h-screen pb-20">
            ...
            <div className="bg-secondary/30 pt-32 pb-16 px-4 mb-8">
                <div className="max-w-7xl mx-auto text-center">
                    <h1 className="text-5xl md:text-7xl font-serif font-bold mb-4 text-foreground">Shop All</h1>
                    <p className="text-muted-foreground/60 max-w-2xl mx-auto text-sm uppercase tracking-widest font-bold">
                        Discover clean, effective botanical essentials designed to enhance your natural radiance.
                    </p>
                </div>
            </div>
