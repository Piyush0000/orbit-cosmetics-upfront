        ...
        <section className="relative py-8 sm:py-16 px-4 bg-background overflow-hidden">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-0 rounded-2xl sm:rounded-[2rem] overflow-hidden border border-border/30 shadow-lg shadow-primary/5">
                    {/* Left content panel */}
                    <div className="lg:col-span-3 bg-gradient-to-br from-primary via-primary/90 to-primary/80 p-6 sm:p-10 md:p-14 text-white flex flex-col justify-center relative overflow-hidden">
                        <div className="absolute top-0 right-0 w-[200px] sm:w-[300px] h-[200px] sm:h-[300px] bg-white/5 rounded-full blur-[80px] translate-x-1/3 -translate-y-1/3" />
                        <div className="absolute bottom-0 left-0 w-[150px] sm:w-[200px] h-[150px] sm:h-[200px] bg-accent/10 rounded-full blur-[60px] -translate-x-1/3 translate-y-1/3" />
                    ...
                    <div className="lg:col-span-2 bg-gradient-to-br from-secondary/30 to-muted/40 p-6 sm:p-10 md:p-14 flex flex-col justify-center items-center">
