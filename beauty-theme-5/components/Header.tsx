...
export function Header() {
    ...
    return (
        <header className={`sticky top-0 z-50 w-full transition-all duration-500 ${isScrolled ? "bg-background/85 backdrop-blur-xl shadow-sm shadow-primary/5 border-b border-border/40" : "bg-transparent"}`}>
